...
*
*> Download SSKEWSTEDC + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewstedc.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewstedc.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewstedc.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSTEDC( COMPZ, N, E, Z, LDZ, WORK, LWORK, IWORK,
*                          LIWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          COMPZ
...
*> \verbatim
*>
*> SSKEWSTEDC computes all eigenvalues and, optionally, eigenvectors of a
...
*> \verbatim
*>
*>  Derived from subroutine sstedc.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSTEDC( COMPZ, N, E, Z, LDZ, WORK, LWORK,
     $                   IWORK, LIWORK, INFO )
      IMPLICIT NONE
*
...
*     .. External Functions ..
      LOGICAL            LSAME
      INTEGER            ILAENV
      REAL               SLAMCH, SLANSKEWST, SROUNDUP_LWORK
      EXTERNAL           ILAENV, LSAME, SLAMCH, SLANSKEWST,
     $                   SROUNDUP_LWORK
*     ..
*     .. External Subroutines ..
      EXTERNAL           SGEMM, SLACPY, SLAEDSKEW0, SLASCL, SLASET,
...
*
         SMLSIZ = ILAENV( 9, 'SSKEWSTEDC', ' ', 0, 0, 0, 0 )
...
*
      ...
      END IF
*
*     If COMPZ = 'N', use SSKEWSTEQR to compute the eigenvalues.
*
      IF( ICOMPZ.EQ.0 ) THEN
         CALL SSKEWSTEQR( 'N', N, E, Z, LDZ, WORK, INFO )
         GO TO 70
      END IF
*
...
*
         CALL SSKEWSTEQR( COMPZ, N, E, Z, LDZ, WORK, INFO )
*
      ELSE
*
...
*
               ...
               ELSE
                  STRTRW = START
               END IF
               CALL SLAEDSKEW0( ICOMPZ, N, M, E( START ),
...
*
                  CALL SSKEWSTEQR( 'I', M, E( START ), WORK,
     $                         M, WORK( M*M+1 ), INFO )
     ...
     $                        Z( 1, START ), LDZ )
               ELSE IF( ICOMPZ.EQ.2 ) THEN
                  CALL SSKEWSTEQR( 'I', M, E( START ),
     $                         Z( START, START ), LDZ, WORK, INFO )
               ELSE
                  CALL SSKEWSTEQR( 'N', M, E( START ),
     $                         Z( START, START ), LDZ, WORK, INFO )
               END IF
               IF( INFO.NE.0 ) THEN
                  GO TO 70
