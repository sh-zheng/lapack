*> \brief \b SLASKEWSYF computes a partial factorization of a real skew-symmetric matrix using the Bunch partial pivoting method.
*
*  =========== DOCUMENTATION ===========
*
...
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/slaskewsyf.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/slaskewsyf.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/slaskewsyf.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SLASKEWSYF( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> SLASKEWSYF computes a partial factorization of a real skew-symmetric matrix A
...
*>
*> SLASKEWSYF is an auxiliary routine called by SKYTRF. It uses blocked code
...
*
*  =====================================================================
      SUBROUTINE SLASKEWSYF( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW,
     $					 INFO )
      IMPLICIT NONE
*
