...
*
*> Download DSKEWSYGVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dskewsygvx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dskewsygvx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dskewsygvx.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DSKEWSYGVX( ITYPE, JOBZ, RANGE, UPLO, N, A, LDA, B, LDB,
...
*> \verbatim
*>
*> DSKEWSYGVX computes selected eigenvalues, and optionally, eigenvectors
...
*>          > 0:  DPOTRF or DSKEWSYEVX returned an error code:
*>             <= N:  if INFO = i, DSKEWSYEVX failed to converge;
...
*> \verbatim
*>
*>  Derived from subroutine dsygvx.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE DSKEWSYGVX( ITYPE, JOBZ, RANGE, UPLO, N, A, LDA, B,
...
*     .. External Subroutines ..
      EXTERNAL           DPOTRF, DSKEWSYEVX, DSKEWSYGST, DTRMM,
     $                   DTRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
      CALL DSKEWSYGST( ITYPE, UPLO, N, A, LDA, B, LDB, INFO )
      CALL DSKEWSYEVX( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL,
     $             IU, ABSTOL,
