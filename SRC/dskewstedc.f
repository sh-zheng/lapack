...
*
*> Download DSKEWSTEDC + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dskewstedc.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dskewstedc.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dskewstedc.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DSKEWSTEDC( COMPZ, N, E, Z, LDZ, WORK, LWORK, IWORK,
*                          LIWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          COMPZ
...
*> \verbatim
*>
*> DSKEWSTEDC computes all eigenvalues and, optionally, eigenvectors of a
...
*> \verbatim
*>
*>  Derived from subroutine dstedc.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE DSKEWSTEDC( COMPZ, N, E, Z, LDZ, WORK, LWORK,
     $                   IWORK, LIWORK, INFO )
      IMPLICIT NONE
*
...
*     .. External Functions ..
      ...
      EXTERNAL           ILAENV, LSAME, DLAMCH, DLANSKEWST
*     ..
*     .. External Subroutines ..
      EXTERNAL           DGEMM, DLACPY, DLAEDSKEW0, DLASCL, DLASET,
...
*
         SMLSIZ = ILAENV( 9, 'DSKEWSTEDC', ' ', 0, 0, 0, 0 )
...
*
      ...
      END IF
*
*     If COMPZ = 'N', use DSKEWSTEQR to compute the eigenvalues.
*
      IF( ICOMPZ.EQ.0 ) THEN
         CALL DSKEWSTEQR( 'N', N, E, Z, LDZ, WORK, INFO )
         GO TO 70
      END IF
*
...
*
         CALL DSKEWSTEQR( COMPZ, N, E, Z, LDZ, WORK, INFO )
*
      ELSE
*
...
*
               ...
               ELSE
                  STRTRW = START
               END IF
               CALL DLAEDSKEW0( ICOMPZ, N, M, E( START ),
...
*
                  CALL DSKEWSTEQR( 'I', M, E( START ), WORK,
     $                         M, WORK( M*M+1 ), INFO )
     ...
     $                        Z( 1, START ), LDZ )
               ELSE IF( ICOMPZ.EQ.2 ) THEN
                  CALL DSKEWSTEQR( 'I', M, E( START ),
     $                         Z( START, START ), LDZ, WORK, INFO )
               ELSE
                  CALL DSKEWSTEQR( 'N', M, E( START ),
     $                         Z( START, START ), LDZ, WORK, INFO )
               END IF
               IF( INFO.NE.0 ) THEN
                  GO TO 70
