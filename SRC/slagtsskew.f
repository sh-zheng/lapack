*> \brief \b SLAGTSSKEW solves the system of equations (T-λI)x = y
...
*
*> Download SLAGTSSKEW + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/slagtsskew.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/slagtsskew.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/slagtsskew.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SLAGTSSKEW( JOB, N, A, B, C, D, IN, YR, YI, TOL, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            INFO, JOB, N
*       REAL               TOL
...
*> \verbatim
*>
*> SLAGTSSKEW may be used to solve one of the systems of equations
*>
...
*>    (T - lambda*I) = P*L*U ,
*>
*> by routine SLAGTFSKEW. The choice of equation to be solved is
...
*> \verbatim
*>          JOB is INTEGER
*>          Specifies the job to be performed by SLAGTSSKEW as follows:
...
*>          of U as returned from SLAGTFSKEW.
*> \endverbatim
*>
*> \param[in] IN
*> \verbatim
...
*> \verbatim
*>
*>  Derived from subroutine slagts.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE SLAGTSSKEW( JOB, N, A, B, C, D, IN, YR, YI, TOL,
     $                    INFO )
      IMPLICIT NONE
*
