*> \brief <b> DSKEWSYSV computes the solution to system of linear equations A * X = B for KY matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download DSKEWSYSV + dependencies
...
*  ===========
*
*       SUBROUTINE DSKEWSYSV( UPLO, N, NRHS, A, LDA, IPIV, B, LDB, WORK,
*                         LWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> DSKEWSYSV computes the solution to a real system of linear equations
*>    A * X = B,
...
*>
*  =====================================================================
      SUBROUTINE DSKEWSYSV( UPLO, N, NRHS, A, LDA, IPIV, B, LDB,
     $                  WORK, LWORK, INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, DSKEWSYTRF, DSKEWSYTRS, DSKEWSYTRS2
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
      IF( INFO.EQ.0 ) THEN
         IF( N.EQ.0 ) THEN
            LWKOPT = 1
         ELSE
            CALL DSKEWSYTRF( UPLO, N, A, LDA, IPIV, WORK, -1, INFO )
            LWKOPT = INT( WORK( 1 ) )
         END IF
         WORK( 1 ) = LWKOPT
      END IF
...
*
      CALL DSKEWSYTRF( UPLO, N, A, LDA, IPIV, WORK, LWORK, INFO )
      IF( INFO.EQ.0 ) THEN
*
...
*
            CALL DSKEWSYTRS( UPLO, N, NRHS, A, LDA, IPIV, B, LDB,
     $                       INFO )
*
         ELSE
*
...
*
            CALL DSKEWSYTRS2( UPLO,N,NRHS,A,LDA,IPIV,B,LDB,WORK,
     $                        INFO )
*
         END IF
*
