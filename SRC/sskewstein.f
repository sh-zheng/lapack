...
*
*> Download SSKEWSTEIN + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewstein.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewstein.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewstein.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSTEIN( N, E, M, W, IBLOCK, ISPLIT, Z, LDZ, WORK,
*                          IWORK, IFAIL, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> SSKEWSTEIN computes the eigenvectors of a real skew-symmetric tridiagonal
...
*> \verbatim
*>
*>  Derived from subroutine sstein.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSTEIN( N, E, M, W, IBLOCK, ISPLIT, Z, LDZ,
...
*     .. External Subroutines ..
      EXTERNAL           SAXPY, SCOPY, SLAGTF, SLAGTS, SLAGTFSKEW,
     $                   SLAGTSSKEW, SLARNV, SSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
               TOL = ZERO
               CALL SLAGTFSKEW( BLKSIZ, WORK( INDRV4+1 ), -XJ,
...
*
               CALL SLAGTSSKEW( -1, BLKSIZ, WORK( INDRV4+1 ),
     $                       WORK( INDRV2+2 ), WORK( INDRV3+1 ),
     $                       WORK( INDRV5+1 ), IWORK,
