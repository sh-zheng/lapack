*> \brief <b> SSKEWSYEVD computes the eigenvalues and, optionally, the left and/or right eigenvectors for SKEWSY matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download SSKEWSYEVD + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewsyevd.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewsyevd.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewsyevd.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSYEVD( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, IWORK,
*                          LIWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          JOBZ, UPLO
...
*> \verbatim
*>
*> SSKEWSYEVD computes all eigenvalues and, optionally, eigenvectors of a
*> real skew-symmetric matrix A. If eigenvectors are desired, it uses a
*> divide and conquer algorithm.
*>
*> Because of large use of BLAS of level 3, SSKEWSYEVD needs N**2 more
...
*> \verbatim
*>
*>  Derived from subroutine ssyevd.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSYEVD( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK,
     $                   IWORK,
     $                   LIWORK, INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           SLACPY, SORMTR, SSCAL, SSKEWSTEDC,
     $                   SSKEWSYTRD, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, SQRT
...
*
      IF( INFO.EQ.0 ) THEN
         ...
         ELSE
            ...
            END IF
            LOPT = MAX( LWMIN, N +
     $                  N*ILAENV( 1, 'SSKEWSYTRD', UPLO, N, -1, -1,
     $                            -1 ) )
            LIOPT = LIWMIN
         END IF
...
*
      CALL SSKEWSYTRD( UPLO, N, A, LDA, W, WORK( INDTAU ),
     $             WORK( INDWRK ), LLWORK, IINFO )
*
*     For eigenvalues only, call SSKEWSTEDC.  For eigenvectors, first call
*     SSKEWSTEDC to generate the eigenvector matrix, WORK(INDWRK), of the
...
*
     ...
     $   CALL SSCAL(N-1, -ONE, W, 1)
      IF( .NOT.WANTZ ) THEN
         CALL SSKEWSTEDC( 'N', N, W, WORK( INDWRK ), N,
     $               WORK( INDWK2 ), LLWRK2, IWORK, LIWORK, INFO )
      ELSE
         CALL SSKEWSTEDC( 'I', N, W, WORK( INDWRK ), N,
     $               WORK( INDWK2 ), LLWRK2, IWORK, LIWORK, INFO )
