...
*
*> Download DSKEWSYGV + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dskewsygv.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dskewsygv.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dskewsygv.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DSKEWSYGV( ITYPE, JOBZ, UPLO, N, A, LDA, B, LDB, W, WORK,
*                         LWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          JOBZ, UPLO
...
*> \verbatim
*>
*> DSKEWSYGV computes all the eigenvalues, and optionally, the eigenvectors
...
*>          > 0:  DPOTRF or DSKEWSYEV returned an error code:
*>             <= N:  if INFO = i, DSKEWSYEV failed to converge;
...
*>
*  =====================================================================
      SUBROUTINE DSKEWSYGV( ITYPE, JOBZ, UPLO, N, A, LDA, B, LDB, W,
     $                  WORK, LWORK, INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           DPOTRF, DSKEWSYEV, DSKEWSYGST, DTRMM,
     $                   DTRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
...
*
      ...
      CALL DSKEWSYEV( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, INFO )
*
      IF( WANTZ ) THEN
*
