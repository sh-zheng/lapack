...
*
*> Download SSKEWSTEBZ + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewstebz.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewstebz.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewstebz.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSTEBZ( RANGE, ORDER, N, VL, VU, IL, IU, ABSTOL, E,
...
*> \verbatim
*>
*> SSKEWSTEBZ computes the eigenvalues of a skew-symmetric tridiagonal
...
*>          eigenvalues.  (SSKEWSTEBZ may use the remaining N-M elements as
*>          workspace.)
*> \endverbatim
*>
*> \param[out] IBLOCK
...
*>          belongs.  (SSKEWSTEBZ may use the remaining N-M elements as
*>          workspace.)
*> \endverbatim
*>
*> \param[out] ISPLIT
...
*> \verbatim
*>
*>  Derived from subroutine sstebz.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSTEBZ( RANGE, ORDER, N, VL, VU, IL, IU,
     $                   ABSTOL, E, M, NSPLIT, W, IBLOCK, ISPLIT,
     $                   WORK, IWORK, INFO )
      IMPLICIT NONE
*
...
*
      ...
      ULP = SLAMCH( 'P' )
      RTOLI = ULP*RELFAC
      NB = ILAENV( 1, 'SSKEWSTEBZ', ' ', N, -1, -1, -1 )
      IF( NB.LE.1 )
     $   NB = 0
*
