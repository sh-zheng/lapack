*> \brief \b DLASKEWSYF computes a partial factorization of a real skew-symmetric matrix using the Bunch partial pivoting method.
*
*  =========== DOCUMENTATION ===========
*
...
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlaskewsyf.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlaskewsyf.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlaskewsyf.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DLASKEWSYF( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> DLASKEWSYF computes a partial factorization of a real skew-symmetric matrix A
...
*>
*> DLASKEWSYF is an auxiliary routine called by DKYTRF. It uses blocked code
...
*>             first element of IPIV is 0, and is the only element not in pair.
...
*>             element in the pair always keeps the value 0.  If N is odd, the
*>             last element of IPIV is 0, and is the only element not in pair.
...
*
*  =====================================================================
      SUBROUTINE DLASKEWSYF( UPLO, N, NB, KB, A, LDA, IPIV, W, LDW,
     $					 INFO )
      IMPLICIT NONE
*
