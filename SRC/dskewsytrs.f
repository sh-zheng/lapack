...
*
*> Download DSKEWSYTRS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dskewsytrs.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dskewsytrs.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dskewsytrs.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DSKEWSYTRS( UPLO, N, NRHS, A, LDA, IPIV, B, LDB, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> DSKEWSYTRS solves a system of linear equations A*X = B with a real
*> skew-symmetric matrix A using the factorization A = U*D*U**T or
*> A = L*D*L**T computed by DSKEWSYTRF.
...
*>
*  =====================================================================
      SUBROUTINE DSKEWSYTRS( UPLO, N, NRHS, A, LDA, IPIV, B, LDB,
     $                       INFO )
      IMPLICIT NONE
*
