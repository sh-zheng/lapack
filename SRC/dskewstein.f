...
*
*> Download DSKEWSTEIN + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dskewstein.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dskewstein.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dskewstein.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DSKEWSTEIN( N, E, M, W, IBLOCK, ISPLIT, Z, LDZ, WORK,
*                          IWORK, IFAIL, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DSKEWSTEIN computes the eigenvectors of a real skew-symmetric tridiagonal
...
*> \verbatim
*>
*>  Derived from subroutine dstein.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE DSKEWSTEIN( N, E, M, W, IBLOCK, ISPLIT, Z, LDZ,
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DCOPY, DLAGTF, DLAGTS, DLAGTFSKEW,
     $                   DLAGTSSKEW, DLARNV, DSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
               TOL = ZERO
               CALL DLAGTFSKEW( BLKSIZ, WORK( INDRV4+1 ), -XJ,
...
*
               CALL DLAGTSSKEW( -1, BLKSIZ, WORK( INDRV4+1 ),
     $                       WORK( INDRV2+2 ), WORK( INDRV3+1 ),
     $                       WORK( INDRV5+1 ), IWORK,
