*> \brief \b DLAGTFSKEW computes an LU factorization of a matrix T-λI, where T is a general tridiagonal matrix with purely imaginary diagonal, and λ a purely imaginary scalar, using partial pivoting with row interchanges.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download DLAGTFSKEW + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlagtfskew.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlagtfskew.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlagtfskew.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DLAGTFSKEW( N, A, LAMBDA, B, C, TOL, D, IN, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            INFO, N
...
*> \verbatim
*>
*> DLAGTFSKEW factorizes the matrix (T - lambda*I), where T is an n by n
...
*>
*> The parameter LAMBDA is included in the routine so that DLAGTFSKEW may
*> be used, in conjunction with SLAGTSSKEW, to obtain eigenvectors of T by
*> inverse iteration.
*>
...
*> \verbatim
*>
*>  Derived from subroutine slagtf.
*>
*> \endverbatim
*
*> \par Contributors:
