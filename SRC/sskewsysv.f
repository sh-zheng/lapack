*> \brief <b> SSKEWSYSV computes the solution to system of linear equations A * X = B for KY matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download SSKEWSYSV + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewsysv.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewsysv.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewsysv.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSYSV( UPLO, N, NRHS, A, LDA, IPIV, B, LDB, WORK,
*                         LWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> SSKEWSYSV computes the solution to a real system of linear equations
*>    A * X = B,
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSYSV( UPLO, N, NRHS, A, LDA, IPIV, B, LDB,
     $                  WORK, LWORK, INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, SSKEWSYTRF, SSKEWSYTRS, SSKEWSYTRS2
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
      IF( INFO.EQ.0 ) THEN
         IF( N.EQ.0 ) THEN
            LWKOPT = 1
         ELSE
            CALL SSKEWSYTRF( UPLO, N, A, LDA, IPIV, WORK, -1, INFO )
            LWKOPT = INT( WORK( 1 ) )
         END IF
...
*
      CALL SSKEWSYTRF( UPLO, N, A, LDA, IPIV, WORK, LWORK, INFO )
      IF( INFO.EQ.0 ) THEN
*
...
*
            CALL SSKEWSYTRS( UPLO, N, NRHS, A, LDA, IPIV, B, LDB,
     $                       INFO )
*
         ELSE
*
...
*
            CALL SSKEWSYTRS2( UPLO,N,NRHS,A,LDA,IPIV,B,LDB,WORK,
     $                        INFO )
*
         END IF
*
