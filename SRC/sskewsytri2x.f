...
*
*> Download SSKEWSYTRI2X + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewsytri2x.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewsytri2x.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewsytri2x.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSYTRI2X( UPLO, N, A, LDA, IPIV, WORK, NB, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> SSKEWSYTRI2X computes the inverse of a real skew-symmetric indefinite matrix
...
*>          used to obtain the factor U or L as computed by SSKEWSYTRF.
*>
...
*>          > 0: if INFO = i, D(i-1,i) = 0 (UPLO = 'U') or D(i+1,i) = 0 (UPLO = 'L');
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSYTRI2X( UPLO, N, A, LDA, IPIV, WORK, NB,
     $                         INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           SSKEWSYCONV, XERBLA, STRTRI
      EXTERNAL           SGEMM, STRMM, SSKEWSYSWAPR
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
      CALL SSKEWSYCONV( UPLO, 'C', N, A, LDA, IPIV, WORK, IINFO )
*
...
*
            ...
            DO WHILE ( I .LT. N )
               IF( IPIV(I+1) .GT. 0 ) THEN
                 ...
                 I=I+1
                 IF ( (I-1) .LT. IP)
     $              CALL SSKEWSYSWAPR( UPLO, N, A, LDA, I-1 ,IP )
                 IF ( (I-1) .GT. IP)
     $              CALL SSKEWSYSWAPR( UPLO, N, A, LDA, IP ,I-1 )
     ...
     $              CALL SSKEWSYSWAPR( UPLO, N, A, LDA, I-1 ,IP )
                 IF ( (I-1) .GT. IP)
     $              CALL SSKEWSYSWAPR( UPLO, N, A, LDA, IP ,I-1 )
                 CALL SSKEWSYSWAPR( UPLO, N, A, LDA, I-1 ,I )
               ELSE
                 I=I+1
               ENDIF
               I=I+1
...
*
            ...
            DO WHILE ( I .GT. 1 )
               IF( IPIV(I-1) .GT. 0 ) THEN
                 IP=IPIV(I-1)
                 IF ( I .LT. IP) CALL SSKEWSYSWAPR( UPLO, N, A, LDA,
     $                I, IP  )
                 IF ( I .GT. IP) CALL SSKEWSYSWAPR( UPLO, N, A, LDA,
     $                IP, I )
                 I=I-1
               ELSEIF( IPIV(I-1) .LT. 0 ) THEN
                 IP=-IPIV(I-1)
