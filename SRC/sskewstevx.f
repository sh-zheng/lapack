*> \brief <b> SSKEWSTEVX computes the eigenvalues and, optionally, the left and/or right eigenvectors for OTHER matrices</b>
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download SSKEWSTEVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewstevx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewstevx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewstevx.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSTEVX( JOBZ, RANGE, N, E, VL, VU, IL, IU, ABSTOL,
...
*> \verbatim
*>
*> SSKEWSTEVX computes selected eigenvalues and, optionally, eigenvectors
...
*> \verbatim
*>
*>  Derived from subroutine sstevx.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSTEVX( JOBZ, RANGE, N, E, VL, VU, IL, IU,
     $                   ABSTOL,
     $                   M, W, Z, LDZ, WORK, IWORK, IFAIL, INFO )
      IMPLICIT NONE
*
...
*     .. External Functions ..
      LOGICAL            LSAME
      REAL               SLAMCH, SLANSKEWST
      EXTERNAL           LSAME, SLAMCH, SLANSKEWST
*     ..
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SSCAL, SSKEWSTEBZ, SSKEWSTEIN,
     $                   SSKEWSTEQR SSWAP, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*     call SSKEWSTEQR.  If this fails for some eigenvalue, then
*     try SSKEWSTEBZ.
*
      TEST = .FALSE.
      IF( INDEIG ) THEN
...
*      IF( ( ALLEIG .OR. TEST ) .AND. ( ABSTOL.LE.ZERO ) ) THEN
      IF( .FALSE. ) THEN
         ...
         INDWRK = N + 1
         CALL SSKEWSTEQR( 'I', N, W, Z, LDZ, WORK( INDWRK ),
     $                INFO )
         IF( INFO.EQ.0 ) THEN
            DO 10 I = 1, N
               IFAIL( I ) = 0
...
*
      ...
      INDISP = 1 + N
      INDIWO = INDISP + N
      CALL SSKEWSTEBZ( RANGE, ORDER, N, VLL, VUU, IL, IU, ABSTOL, E,
     $             M,
     $             NSPLIT, W, IWORK( 1 ), IWORK( INDISP ),
     $             WORK( INDWRK ), IWORK( INDIWO ), INFO )
*
      IF( WANTZ ) THEN
         CALL SSKEWSTEIN( N, E, M, W, IWORK( 1 ), IWORK( INDISP ),
