...
*
*> Download SSKEWSYGV + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewsygv.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewsygv.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewsygv.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSYGV( ITYPE, JOBZ, UPLO, N, A, LDA, B, LDB, W, WORK,
*                         LWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          JOBZ, UPLO
...
*> \verbatim
*>
*> SSKEWSYGV computes all the eigenvalues, and optionally, the eigenvectors
...
*>          > 0:  SPOTRF or SSKEWSYEV returned an error code:
*>             <= N:  if INFO = i, SSKEWSYEV failed to converge;
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSYGV( ITYPE, JOBZ, UPLO, N, A, LDA, B, LDB, W,
     $                  WORK, LWORK, INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           SPOTRF, SSKEWSYEV, SSKEWSYGST, STRMM,
     $                   STRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
...
*
      ...
      CALL SSKEWSYEV( JOBZ, UPLO, N, A, LDA, W, WORK, LWORK, INFO )
*
      IF( WANTZ ) THEN
*
