*> \brief \b DLAGTSSKEW solves the system of equations (T-λI)x = y
...
*
*> Download DLAGTSSKEW + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlagtsskew.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlagtsskew.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlagtsskew.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DLAGTSSKEW( JOB, N, A, B, C, D, IN, YR, YI, TOL, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            INFO, JOB, N
...
*> \verbatim
*>
*> DLAGTSSKEW may be used to solve one of the systems of equations
*>
...
*>    (T - lambda*I) = P*L*U ,
*>
*> by routine DLAGTFSKEW. The choice of equation to be solved is
...
*> \verbatim
*>          JOB is INTEGER
*>          Specifies the job to be performed by DLAGTSSKEW as follows:
...
*>          of U as returned from DLAGTFSKEW.
*> \endverbatim
*>
*> \param[in] IN
*> \verbatim
...
*> \verbatim
*>
*>  Derived from subroutine dlagts.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE DLAGTSSKEW( JOB, N, A, B, C, D, IN, YR, YI, TOL,
     $                    INFO )
      IMPLICIT NONE
*
