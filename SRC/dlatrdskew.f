*> \brief \b DLATRDSKEW reduces the first nb rows and columns of a skew-symmetric/Hermitian matrix A to real tridiagonal form by an orthogonal similarity transformation.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download DLATRDSKEW + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dlatrdskew.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dlatrdskew.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dlatrdskew.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DLATRDSKEW( UPLO, N, NB, A, LDA, E, TAU, W, LDW )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> DLATRDSKEW reduces NB rows and columns of a real skew-symmetric matrix A to
*> skew-symmetric tridiagonal form by an orthogonal similarity
*> transformation Q**T * A * Q, and returns the matrices V and W which are
*> needed to apply the transformation to the unreduced part of A.
*>
*> If UPLO = 'U', DLATRDSKEW reduces the last NB rows and columns of a
*> matrix, of which the upper triangle is supplied;
*> if UPLO = 'L', DLATRDSKEW reduces the first NB rows and columns of a
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DGEMV, DLARFG, DSCAL, DSKEWSYMV
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*              Compute W(1:i-1,i)
*
               CALL DSKEWSYMV( 'Upper', I-1, ONE, A, LDA, A( 1, I ),
     $                     1, ZERO, W( 1, IW ), 1 )
               IF( I.LT.N ) THEN
...
*              Compute W(i+1:n,i)
*
               CALL DSKEWSYMV( 'Lower', N-I, ONE, A( I+1, I+1 ),
     $                     LDA, A( I+1, I ), 1, ZERO,
     $                     W( I+1, I ), 1 )
