...
*
*> Download SSKEWSYTRF + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewsytrf.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewsytrf.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewsytrf.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSYTRF( UPLO, N, A, LDA, IPIV, WORK, LWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> SSKEWSYTRF computes the factorization of a real skew-symmetric matrix A using
...
*>          Details of the interchanges of D, as determined by SSKEWSYTRF.
*>
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSYTRF( UPLO, N, A, LDA, IPIV, WORK, LWORK,
     $                       INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           SLASKEWSYF, SSKEWSYTF2, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
      ...
      IF( NB.GT.1 .AND. NB.LT.N ) THEN
         ...
         IF( LWORK.LT.IWS ) THEN
            ...
            NBMIN = MAX( 2, ILAENV( 2, 'SSKEWSYTRF', UPLO, N, -1, -1,
     $                   -1 ) )
         END IF
      ELSE
         IWS = 1
...
*        KB, where KB is the number of columns factorized by SLASKEWSYF;
...
*
            CALL SLASKEWSYF( UPLO, K, NB, KB, A, LDA, IPIV, WORK,
     $                   LDWORK, IINFO )
         ELSE
*
*           Use unblocked code to factorize columns 1:k of A
*
            CALL SSKEWSYTF2( UPLO, K, A, LDA, IPIV, IINFO )
            KB = K
         END IF
*
...
*
            CALL SLASKEWSYF( UPLO, N-K+1, NB, KB, A( K, K ), LDA,
     $                   IPIV( K ),
     $                   WORK, LDWORK, IINFO )
         ELSE
*
...
*
            CALL SSKEWSYTF2( UPLO, N-K+1, A( K, K ), LDA, IPIV( K ),
     $                   IINFO )
            KB = N - K + 1
         END IF
*
