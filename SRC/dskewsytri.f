...
*
*> Download DSKEWSYTRI + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dskewsytri.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dskewsytri.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dskewsytri.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DSKEWSYTRI( UPLO, N, A, LDA, IPIV, WORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            INFO, LDA, N
...
*> \verbatim
*>
*> DSKEWSYTRI computes the inverse of a real skew-symmetric indefinite matrix
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, DSWAP, DSKEWSYMV, DSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
*     ..
...
*
         IF( K.GT.1 ) THEN
            ...
            CALL DSKEWSYMV( UPLO, K-1, -ONE, A, LDA, WORK, 1, ZERO,
     $                  A( 1, K ), 1 )
            A( K, K+1 ) = A( K, K+1 ) +
...
*
         IF( K.LT.N ) THEN
            ...
            CALL DSKEWSYMV( UPLO, N-K, -ONE, A( K+1, K+1 ), LDA, WORK,
     $                  1, ZERO, A( K+1, K ), 1 )
            A( K, K-1 ) = A( K, K-1 ) +
