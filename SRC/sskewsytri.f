...
*
*> Download SSKEWSYTRI + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewsytri.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewsytri.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewsytri.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSYTRI( UPLO, N, A, LDA, IPIV, WORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            INFO, LDA, N
...
*> \verbatim
*>
*> SSKEWSYTRI computes the inverse of a real skew-symmetric indefinite matrix
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SSWAP, SSKEWSYMV, SSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, MAX
*     ..
...
*
         IF( K.GT.1 ) THEN
            ...
            CALL SSKEWSYMV( UPLO, K-1, -ONE, A, LDA, WORK, 1, ZERO,
     $                  A( 1, K ), 1 )
            A( K, K+1 ) = A( K, K+1 ) +
...
*
         IF( K.LT.N ) THEN
            ...
            CALL SSKEWSYMV( UPLO, N-K, -ONE, A( K+1, K+1 ), LDA, WORK,
     $                  1, ZERO, A( K+1, K ), 1 )
            A( K, K-1 ) = A( K, K-1 ) +
