...
*
*> Download SSKEWSYGVX + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sskewsygvx.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sskewsygvx.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sskewsygvx.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE SSKEWSYGVX( ITYPE, JOBZ, RANGE, UPLO, N, A, LDA, B, LDB,
...
*> \verbatim
*>
*> SSKEWSYGVX computes selected eigenvalues, and optionally, eigenvectors
...
*>          > 0:  SPOTRF or SSKEWSYEVX returned an error code:
*>             <= N:  if INFO = i, SSKEWSYEVX failed to converge;
...
*> \verbatim
*>
*>  Derived from subroutine ssygvx.
*>
*> \endverbatim
*
*> \par Contributors:
...
*>
*  =====================================================================
      SUBROUTINE SSKEWSYGVX( ITYPE, JOBZ, RANGE, UPLO, N, A, LDA, B,
...
*     .. External Subroutines ..
      EXTERNAL           SPOTRF, SSKEWSYEVX, SSKEWSYGST, STRMM,
     $                   STRSM, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
      CALL SSKEWSYGST( ITYPE, UPLO, N, A, LDA, B, LDB, INFO )
      CALL SSKEWSYEVX( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL,
     $             IU, ABSTOL,
