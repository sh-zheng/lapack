...
*
*> Download DSKEWSYTRF + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dskewsytrf.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dskewsytrf.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dskewsytrf.f">
*> [TXT]</a>
*
*  Definition:
*  ===========
*
*       SUBROUTINE DSKEWSYTRF( UPLO, N, A, LDA, IPIV, WORK, LWORK, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> DSKEWSYTRF computes the factorization of a real skew-symmetric matrix A using
...
*>          Details of the interchanges of D, as determined by DSKEWSYTRF.
*>
...
*>
*  =====================================================================
      SUBROUTINE DSKEWSYTRF( UPLO, N, A, LDA, IPIV, WORK, LWORK,
     $                       INFO )
      IMPLICIT NONE
*
...
*     .. External Subroutines ..
      EXTERNAL           DLASKEWSYF, DSKEWSYTF2, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
      ...
      IF( NB.GT.1 .AND. NB.LT.N ) THEN
         ...
         IF( LWORK.LT.IWS ) THEN
            ...
            NBMIN = MAX( 2, ILAENV( 2, 'DSKEWSYTRF', UPLO, N, -1, -1,
     $                   -1 ) )
         END IF
      ELSE
         IWS = 1
...
*        KB, where KB is the number of columns factorized by DLASKEWSYF;
...
*
            CALL DLASKEWSYF( UPLO, K, NB, KB, A, LDA, IPIV, WORK,
     $                   LDWORK, IINFO )
         ELSE
*
*           Use unblocked code to factorize columns 1:k of A
*
            CALL DSKEWSYTF2( UPLO, K, A, LDA, IPIV, IINFO )
            KB = K
         END IF
*
...
*
            CALL DLASKEWSYF( UPLO, N-K+1, NB, KB, A( K, K ), LDA,
     $                   IPIV( K ),
     $                   WORK, LDWORK, IINFO )
         ELSE
*
...
*
            CALL DSKEWSYTF2( UPLO, N-K+1, A( K, K ), LDA, IPIV( K ),
     $                   IINFO )
            KB = N - K + 1
         END IF
*
