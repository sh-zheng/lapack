...
*  ===========
*
*       SUBROUTINE DLAGSKEWSY( N, K, D, A, LDA, ISEED, WORK, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DLAGSKEWSY generates a real skew-symmetric matrix A, by pre- and post-
...
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DGEMV, DGER, DLARNV, DSCAL,
     $                   DSKEWSYMV, DSKEWSYR2, XERBLA
*     ..
*     .. External Functions ..
...
*        compute  y := tau * A * u
*
         CALL DSKEWSYMV( 'Lower', N-I+2, TAU, A( I-1, I-1 ), LDA,
     $               WORK, 1, ZERO, WORK( N+1 ), 1 )
*
*        apply the transformation as a rank-2 update to A(i:n,i:n)
*
         CALL DSKEWSYR2( 'Lower', N-I+2, -ONE, WORK, 1, WORK( N+1 ),
     $               1, A( I-1, I-1 ), LDA )
   40 CONTINUE
*
*        generate random reflection
...
*        compute  y := tau * A * u
*
         CALL DSKEWSYMV( 'Lower', N, TAU, A( 1, 1 ), LDA, WORK,
     $               1, ZERO, WORK( N+1 ), 1 )
*
*        apply the transformation as a rank-2 update to A(i:n,i:n)
*
         CALL DSKEWSYR2( 'Lower', N, -ONE, WORK, 1, WORK( N+1 ), 1,
     $               A( 1, 1 ), LDA )
*
...
*
         CALL DGEMV( 'Transpose', N-K-I+1, K-1, ONE, A( K+I, I+1 ),
...
*        compute  y := tau * A * u
*
         CALL DSKEWSYMV( 'Lower', N-K-I+1, TAU, A( K+I, K+I ), LDA,
     $               A( K+I, I ), 1, ZERO, WORK, 1 )
*
*        apply skew-symmetric rank-2 update to A(k+i:n,k+i:n)
*
         CALL DSKEWSYR2( 'Lower', N-K-I+1, -ONE, A( K+I, I ), 1,
     $               WORK, 1, A( K+I, K+I ), LDA )
*
         A( K+I, I ) = -WA
         DO 50 J = K + I + 1, N
            A( J, I ) = ZERO
