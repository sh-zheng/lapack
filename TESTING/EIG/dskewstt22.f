...
*  ===========
*
*       SUBROUTINE DSKEWSTT22( N, M, KBAND, AD, AE, SD, SE, U, LDU, WORK,
*                          LDWORK, RESULT )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DSKEWSTT22  checks a set of M eigenvalues and eigenvectors,
*>
*>     A U = U S
*>
...
*> \verbatim
*>          N is INTEGER
*>          The size of the matrix.  If it is zero, DSKEWSTT22 does nothing.
...
*> \verbatim
*>          M is INTEGER
*>          The number of eigenpairs to check.  If it is zero, DSKEWSTT22
...
*
*  =====================================================================
      SUBROUTINE DSKEWSTT22( N, M, KBAND, AD, AE, SD, SE, U, LDU,
     $                   WORK, LDWORK, RESULT )
      IMPLICIT NONE
*
*  -- LAPACK test routine --
...
*
   ...
   40 CONTINUE
*
      WNORM = DLANSKEWSY( '1', 'L', M, WORK, M, WORK( 1, M+1 ) )
*
