...
*  ===========
*
*       SUBROUTINE DSKEWSGT01( ITYPE, UPLO, N, M, A, LDA, B, LDB, Z, LDZ, D,
*                          WORK, RESULT )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> DSKEWSGT01 checks a decomposition of the form
*>
*>    A Z   =  B Z D or
*>    A B Z =  Z D or
*>    B A Z =  Z D
...
*
*  =====================================================================
      SUBROUTINE DSKEWSGT01( ITYPE, UPLO, N, M, A, LDA, B, LDB, Z,
     $                   LDZ, D, WORK, RESULT )
      IMPLICIT NONE
*
*  -- LAPACK test routine --
...
*     .. External Functions ..
      ...
      EXTERNAL           DLAMCH, DLANGE, DLANSKEWSY
*     ..
*     .. External Subroutines ..
      EXTERNAL           DCOPY, DSCAL, DAXPY, DSYMM, DSKEWSYMM
*     ..
...
*
      ANORM = DLANSKEWSY( '1', UPLO, N, A, LDA, WORK )*
...
*        Norm of AZ - BZD
*
         CALL DSKEWSYMM( 'Left', UPLO, N, M, ONE, A, LDA, Z, LDZ,
     $               ZERO, WORK, N )
         DO 10 I = 1, M-1
...
*
   ...
   40    CONTINUE
         CALL DCOPY( N, Z( 1, M-1 ), 1, WORK(N**2+(M-1)*N+1), 1 )
         CALL DSCAL( N, -D( M-1 ), WORK(N**2+(M-1)*N+1), 1 )
         CALL DSKEWSYMM( 'Left', UPLO, N, M, ONE, A, LDA, WORK, N,
     $               -ONE, WORK(N**2+1), N )
*
