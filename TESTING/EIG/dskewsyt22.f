...
*  ===========
*
*       SUBROUTINE DSKEWSYT22( ITYPE, UPLO, N, M, KBAND, A, LDA, D, E, U, LDU,
...
*> \verbatim
*>
*>      DSKEWSYT22  generally checks a decomposition of the form
*>
*>              A U = U S
*>
...
*>
*>  N       INTEGER
*>          The size of the matrix.  If it is zero, DSKEWSYT22 does nothing.
*>          It must be at least zero.
*>          Not modified.
*>
*>  M       INTEGER
*>          The number of columns of U.  If it is zero, DSKEWSYT22 does
...
*
*  =====================================================================
      SUBROUTINE DSKEWSYT22( ITYPE, UPLO, N, M, KBAND, A, LDA, D,
     $                   E, U, LDU, V, LDV, TAU, WORK, RESULT )
      IMPLICIT NONE
*
*  -- LAPACK test routine --
...
*     .. External Functions ..
      ...
      EXTERNAL           DLAMCH, DLANSKEWSY
*     ..
*     .. External Subroutines ..
      EXTERNAL           DGEMM, DSKEWSYMM
*     ..
*     .. Intrinsic Functions ..
...
*     Norm of A:
*
      ANORM = MAX( DLANSKEWSY( '1', UPLO, N, A, LDA, WORK ), UNFL )
*
*     Compute error matrix:
*
*     ITYPE=1: error = U**T A U - S
*
      CALL DSKEWSYMM( 'L', UPLO, N, M, ONE, A, LDA, U, LDU, ZERO,
     $                WORK, N )
      NN = N*N
      NNP1 = NN + 1
   ...
   20    CONTINUE
      END IF
      WNORM = DLANSKEWSY( '1', UPLO, M, WORK( NNP1 ), N, WORK( 1 ) )
*
