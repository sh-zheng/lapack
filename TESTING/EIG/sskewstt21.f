...
*  ===========
*
*       SUBROUTINE SSKEWSTT21( N, KBAND, AD, AE, SD, SE, U, LDU, WORK,
*                          RESULT )
*
*       .. Scalar Arguments ..
*       INTEGER            KBAND, LDU, N
...
*> \verbatim
*>
*> SSKEWSTT21 checks a decomposition of the form
*>
*>    A = U S U'
*>
...
*> \verbatim
*>          N is INTEGER
*>          The size of the matrix.  If it is zero, SSKEWSTT21 does nothing.
...
*     .. External Subroutines ..
      EXTERNAL           SGEMM, SLASET, SSKEWSYR2
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( N.GT.1 .AND. KBAND.EQ.1 ) THEN
         DO 30 J = 1, N - 1
            CALL SSKEWSYR2( 'L', N, -SE( J ), U( 1, J ), 1,
     $                  U( 1, J+1 ), 1, WORK, N )
   30    CONTINUE
      END IF
*
      WNORM = SLANSKEWSY( '1', 'L', N, WORK, N, WORK( N**2+1 ) )
*
