...
*  ===========
*
*       SUBROUTINE SSKEWSTT22( N, M, KBAND, AD, AE, SD, SE, U, LDU,
*                          WORK, LDWORK, RESULT )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> SSKEWSTT22  checks a set of M eigenvalues and eigenvectors,
*>
*>     A U = U S
*>
...
*> \verbatim
*>          N is INTEGER
*>          The size of the matrix.  If it is zero, SSKEWSTT22 does nothing.
...
*> \verbatim
*>          M is INTEGER
*>          The number of eigenpairs to check.  If it is zero, SSKEWSTT22
...
*
*  =====================================================================
      SUBROUTINE SSKEWSTT22( N, M, KBAND, AD, AE, SD, SE, U, LDU, WORK,
     $                   LDWORK, RESULT )
      IMPLICIT NONE
*
*  -- LAPACK test routine --
...
*
   ...
   40 CONTINUE
*
      WNORM = SLANSKEWSY( '1', 'L', M, WORK, M, WORK( 1, M+1 ) )
*
