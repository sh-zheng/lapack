...
*  ===========
*
*       SUBROUTINE SSKEWSGT01( ITYPE, UPLO, N, M, A, LDA, B, LDB, Z, LDZ, D,
*                          WORK, RESULT )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> SSKEWSGT01 checks a decomposition of the form
*>
*>    A Z   =  B Z D or
*>    A B Z =  Z D or
*>    B A Z =  Z D
...
*
*  =====================================================================
      SUBROUTINE SSKEWSGT01( ITYPE, UPLO, N, M, A, LDA, B, LDB, Z,
     $                   LDZ, D, WORK, RESULT )
      IMPLICIT NONE
*
*  -- LAPACK test routine --
...
*     .. External Functions ..
      ...
      EXTERNAL           SLAMCH, SLANGE, SLANSKEWSY
*     ..
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SSCAL, SAXPY, SSYMM, SSKEWSYMM
*     ..
...
*
      ANORM = SLANSKEWSY( '1', UPLO, N, A, LDA, WORK )*
...
*        Norm of AZ - BZD
*
         CALL SSKEWSYMM( 'Left', UPLO, N, M, ONE, A, LDA, Z, LDZ,
     $               ZERO, WORK, N )
         DO 10 I = 1, M-1
...
*
   ...
   40    CONTINUE
         CALL SCOPY( N, Z( 1, M-1 ), 1, WORK(N**2+(M-1)*N+1), 1 )
         CALL SSCAL( N, -D( M-1 ), WORK(N**2+(M-1)*N+1), 1 )
         CALL SSKEWSYMM( 'Left', UPLO, N, M, ONE, A, LDA, WORK, N,
     $               -ONE, WORK(N**2+1), N )
*
