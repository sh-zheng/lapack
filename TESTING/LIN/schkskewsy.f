...
*  ===========
*
*       SUBROUTINE SCHKSKEWSY( DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSVAL,
...
*> \verbatim
*>
*> SCHKSKEWSY tests SSKEWSYTRF, -TRI2, -TRS, -TRS2, -RFS, and -CON.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
*  =====================================================================
      SUBROUTINE SCHKSKEWSY( DOTYPE, NN, NVAL, NNB, NBVAL, NNS,
...
*     ..
*     .. External Functions ..
      REAL               SGET06, SLANSKEWSY
      EXTERNAL           SGET06, SLANSKEWSY
*     ..
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, SERRSY, SGET04, SLACPY,
     $                   SLARHS, SLATB4, SLATMS, SPOT08, SPOT07, SPOT09,
     $                   SERRSKEWSY, SSKEWSYCON, SSKEWSYCONV,
     $                   SSKEWSYRFS, SSKEWSYT01, SSKEWSYTRF,
     $                   SSKEWSYTRI2, SSKEWSYTRS, SSKEWSYTRS2, LSAME,
     $                   XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
                  LWORK = MAX( 2, NB )*LDA
                  SRNAMT = 'SSKEWSYTRF'
                  CALL SSKEWSYTRF( UPLO, N, AFAC, LDA, IWORK, AINV,
     $                         LWORK, INFO )
*
...
*
  ...
  100                CONTINUE
     ...
     $                  THEN
                  ...
                  END IF
*
*                 Check error code from SSKEWSYTRF and handle error.
*
                  IF( INFO.NE.K )
     $               CALL ALAERH( PATH, 'SSKEWSYTRF', INFO, K, UPLO,
...
*
                  CALL SSKEWSYT01( UPLO, N, A, LDA, AFAC, LDA,
...
*
                  IF( INB.EQ.1 .AND. .NOT.TRFCON ) THEN
                     ...
                     SRNAMT = 'SSKEWSYTRI2'
                     LWORK = (N+NB+1)*(NB+3)
                     CALL SSKEWSYTRI2( UPLO, N, AINV, LDA, IWORK, WORK,
     $                            LWORK, INFO )
*
*                    Check error code from SSKEWSYTRI2 and handle error.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'SSKEWSYTRI2', INFO, -1,
     $                               UPLO, N, N, -1, -1, -1, IMAT,
     $                               NFAIL, NERRS, NOUT )
*
...
*
                     SRNAMT = 'SSKEWSYTRS'
                     CALL SSKEWSYTRS( UPLO, N, NRHS, AFAC, LDA, IWORK,
     $                            X, LDA, INFO )
*
*                    Check error code from SSKEWSYTRS and handle error.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'SSKEWSYTRS', INFO, 0, UPLO,
...
*
                     SRNAMT = 'DSYTRS2'
                     CALL SSKEWSYTRS2( UPLO, N, NRHS, AFAC, LDA, IWORK,
     $                            X, LDA, WORK, INFO )
*
*                    Check error code from SSKEWSYTRS2 and handle error.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'SSKEWSYTRS2', INFO, 0, UPLO,
     $                               N, N, -1, -1, NRHS, IMAT, NFAIL,
     $                               NERRS, NOUT )
*
                     CALL SLACPY( 'Full', N, NRHS, B, LDA, WORK, LDA )
...
*
                     SRNAMT = 'SSKEWSYRFS'
                     CALL SSKEWSYRFS( UPLO, N, NRHS, A, LDA, AFAC,
     $                            LDA, IWORK, B, LDA, X, LDA, RWORK,
     $                            RWORK( NRHS+1 ), WORK, IWORK( N+1 ),
     $                            INFO )
*
*                    Check error code from SSKEWSYRFS and handle error.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'SSKEWSYRFS', INFO, 0, UPLO,
     $                               N, N, -1, -1, NRHS, IMAT, NFAIL,
     $                               NERRS, NOUT )
*
                     CALL SGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
...
*
  140             CONTINUE
                  ANORM = SLANSKEWSY( '1', UPLO, N, A, LDA, RWORK )
                  SRNAMT = 'SSKEWSYCON'
                  CALL SSKEWSYCON( UPLO, N, AFAC, LDA, IWORK, ANORM,
     $                         RCOND, WORK, IWORK( N+1 ), INFO )
*
*                 Check error code from SSKEWSYCON and handle error.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'SSKEWSYCON', INFO, 0, UPLO, N,
