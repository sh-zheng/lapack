...
*
      ...
      AINVNM = DLANSKEWSY( '1', UPLO, N, AINV, LDAINV, RWORK )
...
*
*     Expand AINV into a full matrix and call DSKEWSYMM to multiply
...
*
   ...
   40    CONTINUE
      END IF
      CALL DSKEWSYMM( 'Left', UPLO, N, N, -ONE, A, LDA, AINV,
     $            LDAINV, ZERO, WORK, LDWORK )
*
