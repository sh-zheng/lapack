...
*  ===========
*
*       SUBROUTINE SLAVSKEWSY( UPLO, TRANS, DIAG, N, NRHS, A, LDA, IPIV, B,
*                          LDB, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> SLAVSKEWSY  performs one of the matrix-vector operations
*>    x := A*x  or  x := A'*x,
...
*
*  =====================================================================
      SUBROUTINE SLAVSKEWSY( UPLO, TRANS, DIAG, N, NRHS, A, LDA,
     $                   IPIV, B, LDB, INFO )
      IMPLICIT NONE
*
*  -- LAPACK test routine --
