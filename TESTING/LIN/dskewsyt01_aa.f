...
*  ===========
*
*       SUBROUTINE DSKEWSYT01_AA( UPLO, N, A, LDA, AFAC, LDAFAC, IPIV, C, LDC,
*                             RWORK, RESID )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> DSKEWSYT01_AA reconstructs a skew-symmetric indefinite matrix A from its
...
*>          The pivot indices from DSKEWSYTRF.
*> \endverbatim
*>
*> \param[out] C
*> \verbatim
...
*
*  =====================================================================
      SUBROUTINE DSKEWSYT01_AA( UPLO, N, A, LDA, AFAC, LDAFAC, IPIV,
     $                         C, LDC, RWORK, RESID )
      IMPLICIT NONE
*
*  -- LAPACK test routine --
