...
*  ===========
*
*       SUBROUTINE SCHKSKEWSY_AA( DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSVAL,
...
*> \verbatim
*>
*> SCHKSKEWSY_AA tests SSKEWSYTRF_AA, -TRS_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
*  =====================================================================
      SUBROUTINE SCHKSKEWSY_AA( DOTYPE, NN, NVAL, NNB, NBVAL, NNS,
...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, SERRSKEWSY, SLACPY,
     $                   SLARHS, SLATB4, SLATMS, SPOT07, SSKEWSYT01_AA,
     $                   SSKEWSYTRF_AA, SSKEWSYTRS_AA, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC    MAX, MIN
*     ..
...
*
                  ...
                  LWORK = MAX( 1, N*NB + N )
                  CALL SSKEWSYTRF_AA( UPLO, N, AFAC, LDA, IWORK, AINV,
     $                            LWORK, INFO )
*
...
*
                  IF( INFO.NE.K ) THEN
                     CALL ALAERH( PATH, 'SSKEWSYTRF_AA', INFO, K, UPLO,
...
*
                  CALL SSKEWSYT01_AA( UPLO, N, A, LDA, AFAC, LDA, IWORK,
...
*
                     ...
                     LWORK = MAX( 1, 3*N-2 )
                     CALL SSKEWSYTRS_AA( UPLO, N, NRHS, AFAC, LDA,
...
*
                     IF( INFO.NE.0 ) THEN
                        IF( IZERO.EQ.0 ) THEN
                           CALL ALAERH( PATH, 'SSKEWSYTRS_AA', INFO, 0,
