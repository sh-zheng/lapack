...
*  ===========
*
*       SUBROUTINE DCHKSKEWSY_AA( DOTYPE, NN, NVAL, NNB, NBVAL, NNS, NSVAL,
...
*> \verbatim
*>
*> DCHKSKEWSY_AA tests DSKEWSYTRF_AA, -TRS_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
*  =====================================================================
      SUBROUTINE DCHKSKEWSY_AA( DOTYPE, NN, NVAL, NNB, NBVAL, NNS,
     $                      NSVAL, THRESH, TSTERR, NMAX, A, AFAC,
...
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, DERRSKEWSY, DLACPY,
     $                   DLARHS, DLATB4, DLATMS, DPOT07, DSKEWSYT01_AA,
     $                   DSKEWSYTRF_AA, DSKEWSYTRS_AA, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
                  ...
                  LWORK = MAX( 1, N*NB + N )
                  CALL DSKEWSYTRF_AA( UPLO, N, AFAC, LDA, IWORK, AINV,
     $                            LWORK, INFO )
*
...
*
                  IF( INFO.NE.K ) THEN
                     CALL ALAERH( PATH, 'DSKEWSYTRF_AA', INFO, K, UPLO,
...
*
                  CALL DSKEWSYT01_AA( UPLO, N, A, LDA, AFAC, LDA, IWORK,
...
*
                     ...
                     LWORK = MAX( 1, 3*N-2 )
                     CALL DSKEWSYTRS_AA( UPLO, N, NRHS, AFAC, LDA,
...
*
                     IF( INFO.NE.0 ) THEN
                        IF( IZERO.EQ.0 ) THEN
                           CALL ALAERH( PATH, 'DSKEWSYTRS_AA', INFO, 0,
