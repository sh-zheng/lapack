...
*  ===========
*
*       SUBROUTINE SSKEWSYT01_AA( UPLO, N, A, LDA, AFAC, LDAFAC, IPIV,
*                             C, LDC, RWORK, RESID )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*> \verbatim
*>
*> SSKEWSYT01_AA reconstructs a skew-symmetric indefinite matrix A from its
