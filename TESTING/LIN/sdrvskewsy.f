...
*  ===========
*
*       SUBROUTINE SDRVSKEWSY( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*> \verbatim
*>
*> SDRVSKEWSY tests the driver routines SSKEWSYSV.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
*  =====================================================================
      SUBROUTINE SDRVSKEWSY( DOTYPE, NN, NVAL, NRHS, THRESH,
...
*     .. External Subroutines ..
     ...
     $                   SSKEWSYSV, SSKEWSYSVX, SSKEWSYT01, SSKEWSYTRF,
     $                   SSKEWSYTRI2, LSAME, XLAENV
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*32       SRNAMT
...
*
                     ...
                     CALL SSKEWSYTRF( UPLO, N, AFAC, LDA, IWORK, WORK,
     $                            LWORK, INFO )
                     BIF = INFO
*
...
*
     ...
     $                            LWORK, INFO )
                     AINVNM = SLANSKEWSY( '1', UPLO, N, AINV, LDA,
     $                                    RWORK )
*
...
*
*                    Factor the matrix and solve the system using SSKEWSYSV.
*
                     SRNAMT = 'SSKEWSYSV '
                     CALL SSKEWSYSV( UPLO, N, NRHS, AFAC, LDA, IWORK, X,
     $                           LDA, WORK, LWORK, INFO )
*
...
*
  ...
  100                   CONTINUE
     ...
     $                     THEN
                     ...
                     END IF
*
*                    Check error code from SSKEWSYSV .
*
                     IF( INFO.NE.K ) THEN
                        CALL ALAERH( PATH, 'SSKEWSYSV ', INFO, K, UPLO,
...
*                    residual.
*
                     CALL SSKEWSYT01( UPLO, N, A, LDA, AFAC, LDA, IWORK,
...
*
     ...
     $                        CALL ALADHD( NOUT, PATH )
                           WRITE( NOUT, FMT = 9999 )'SSKEWSYSV ', UPLO,
     $                        N, IMAT, K, RESULT( K )
                           NFAIL = NFAIL + 1
                        END IF
  110                CONTINUE
...
*                 error bounds using SSKEWSYSVX.
*
                  SRNAMT = 'SSKEWSYSVX'
                  CALL SSKEWSYSVX( FACT, UPLO, N, NRHS, A, LDA, AFAC,
...
*
  ...
  130                CONTINUE
     ...
     $                  THEN
                  ...
                  END IF
*
*                 Check the error code from SSKEWSYSVX.
*
                  IF( INFO.NE.K ) THEN
                     CALL ALAERH( PATH, 'SSKEWSYSVX', INFO, K,
...
*
     ...
     $                            RESULT( 4 ) )
                  ...
                  END IF
*
*                 Compare RCOND from SSKEWSYSVX with the computed value
*                 in RCONDC.
*
...
*
                  DO 140 K = K1, 6
                     IF( RESULT( K ).GE.THRESH ) THEN
                        IF( NFAIL.EQ.0 .AND. NERRS.EQ.0 )
     $                     CALL ALADHD( NOUT, PATH )
                        WRITE( NOUT, FMT = 9998 )'SSKEWSYSVX', FACT,
