...
*  ===========
*
*       SUBROUTINE SDRVSKEWSY_AA( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*> \verbatim
*>
*> SDRVSKEWSY_AA tests the driver routine SSKEWSYSV_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
*  =====================================================================
      SUBROUTINE SDRVSKEWSY_AA( DOTYPE, NN, NVAL, NRHS, THRESH,
...
*     ..
*     .. External Functions ..
      REAL               DGET06, SLANSKEWSY
      EXTERNAL           DGET06, SLANSKEWSY
*     ..
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, SERRVX, SGET04, SLACPY,
     $                   SLARHS, SLASET, SLATB4, SLATMS, SPOT07,
     $                   SSKEWSYSV_AA, SSKEWSYT01_AA, SSKEWSYTRF_AA,
     $                   XLAENV
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
...
*
*                    Factor the matrix and solve the system using SSKEWSYSV_AA.
*
                     SRNAMT = 'SSKEWSYSV_AA'
                     CALL SSKEWSYSV_AA( UPLO, N, NRHS, AFAC, LDA, IWORK,
...
*
  ...
  100                   CONTINUE
                     ...
                     END IF
*
*                    Check error code from SSKEWSYSV_AA .
*
                     IF( INFO.NE.K ) THEN
                        CALL ALAERH( PATH, 'SSKEWSYSV_AA ', INFO, K,
     $                               UPLO, N, N, -1, -1, NRHS,
...
*                    residual.
*
                     CALL SSKEWSYT01_AA( UPLO, N, A, LDA, AFAC, LDA,
...
*
     ...
     $                        CALL ALADHD( NOUT, PATH )
                           WRITE( NOUT, FMT = 9999 )'SSKEWSYSV_AA ',
