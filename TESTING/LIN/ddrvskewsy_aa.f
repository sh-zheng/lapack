...
*  ===========
*
*       SUBROUTINE DDRVSKEWSY_AA( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*> \verbatim
*>
*> DDRVSKEWSY_AA tests the driver routine DSKEWSYSV_AA.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*
*  =====================================================================
      SUBROUTINE DDRVSKEWSY_AA( DOTYPE, NN, NVAL, NRHS, THRESH,
     $                      TSTERR, NMAX, A, AFAC, AINV, B, X,
...
*     .. External Subroutines ..
     ...
     $                   DSKEWSYSV_AA, DSKEWSYT01_AA, DSKEWSYTRF_AA,
     $                   XLAENV
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
...
*
*                    Factor the matrix and solve the system using DSKEWSYSV_AA.
*
                     SRNAMT = 'DSKEWSYSV_AA'
                     CALL DSKEWSYSV_AA( UPLO, N, NRHS, AFAC, LDA, IWORK,
...
*
  ...
  100                   CONTINUE
                     ...
                     END IF
*
*                    Check error code from DSKEWSYSV_AA .
*
                     IF( INFO.NE.K ) THEN
                        CALL ALAERH( PATH, 'DSKEWSYSV_AA ', INFO, K,
     $                               UPLO, N, N, -1, -1, NRHS,
...
*                    residual.
*
                     CALL DSKEWSYT01_AA( UPLO, N, A, LDA, AFAC, LDA,
...
*
     ...
     $                        CALL ALADHD( NOUT, PATH )
                           WRITE( NOUT, FMT = 9999 )'DSKEWSYSV_AA ',
