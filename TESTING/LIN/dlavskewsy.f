...
*  ===========
*
*       SUBROUTINE DLAVSKEWSY( UPLO, TRANS, DIAG, N, NRHS, A, LDA, IPIV, B,
*                          LDB, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DLAVSKEWSY  performs one of the matrix-vector operations
*>    x := A*x  or  x := A'*x,
*> where x is an N element vector and A is one of the factors
*> from the block U*D*U' or L*D*L' factorization computed by SSKEWSYTRF.
*>
...
*
*  =====================================================================
      SUBROUTINE DLAVSKEWSY( UPLO, TRANS, DIAG, N, NRHS, A, LDA,
     $                   IPIV, B, LDB, INFO )
      IMPLICIT NONE
*
*  -- LAPACK test routine --
